...
Contributing is easy:
 ...
 - You can report bugs and request features using the https://github.com/madhead/docker-imagemagick/issues[issues page].
...
Make your changes.
Push to your fork and https://github.com/madhead/docker-imagemagick/compare[submit a pull request].
